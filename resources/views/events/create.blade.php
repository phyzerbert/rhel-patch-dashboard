                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="d-flex mb-2">
                            <h4 class="mb-0"><i class="fa fa-calendar-alt"></i> Add Event</h4>
                        </div>
                        <form action="{{route('events.store')}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <textarea rows="5" class="form-control" name="detail" placeholder="Event Detail" maxlength="10000"></textarea>
                            </div>
